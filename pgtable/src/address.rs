...
// Neutralize the verus attribute macros: in this crate `address` is a trusted,
// plain-Rust dependency, so `#[verus_spec]` / `#[verus_verify]` become no-ops.
use verus_macro_stub::*;
